...
(function(){
    ...
    function(){
        var a,b,c,d,e,f,g,h;
        for(e=window,h=["ms","moz","webkit","o"],f=0,g=h.length;g>f&&(d=h[f],!e.requestAnimationFrame);f++)
            e.requestAnimationFrame=e[""+d+"RequestAnimationFrame"],e.cancelAnimationFrame=e[""+d+"CancelAnimationFrame"]||e[""+d+"CancelRequestAnimationFrame"];
        if(e.requestAnimationFrame){
            if(e.cancelAnimationFrame)
                return;
            return a=e.requestAnimationFrame,
            b={},
            e.requestAnimationFrame=function(c){
                var d;
        ...
        return c=0,e.requestAnimationFrame=function(a){
            var b;
            return c=Math.max(c+16,b=+new Date),
    ...
    e=("undefined"!=typeof localStorage&&null!==localStorage?localStorage.getItem:void 0)&&localStorage.getItem("wit_debug")?function(){
        ...
        return this.name="WitError",this.message=a||"",this.infos=b,this},d.prototype=Error.prototype,c="wss://api.wit.ai/speech_ws",a=function(a){
        var b,c;
        return this.conn=null,this.ctx=new AudioContext,this.state="disconnected",this.rec=!1,this.handleError=function(a){
            var b,c;return _.isFunction(c=this.onerror)?(b=_.isString(a)?a:_.isString(a.message)?a.message:"Something went wrong!",c.call(window,b,a)):void 0
        ...
        disconnected:{
            connect:function(a){
                ...
                return a||this.handleError("No token provided"),b=new WebSocket(c),b.onopen=function(){
                    return function(c){
                        var d;
                        return e("connection opened",c),d={token:a,bps:16,encoding:"signed-integer"},b.send(JSON.stringify(["auth",d]))
                    }
                    ...
                    return function(b){
                        ...
                        return c=a.ctx,f=c.createMediaStreamSource(b),d=(c.createScriptProcessor||c.createJavascriptNode).call(c,4096,1,1),d.onaudioprocess=function(b){
                            var c,d,f,g,h,i,j,k;
                            if(a.rec){
                                for(c=b.inputBuffer,d=c.getChannelData(0),h=d.length,g=new Int16Array(h),f=k=0;h>=0?h>=k:k>=h;f=h>=0?++k:--k)
                                    i=d[f],j=0>i?32768*i:32767*i,g[f]=j;
                ...
                }(this),navigator.getUserMedia({audio:!0},d,this.handleError),"connecting"
            }
        },
        connecting:{"auth-ok":function(){
        ...
        waiting_for_auth:{"auth-ok":function(){
            return"ready"
        }
        },
        waiting_for_stream:{got_stream:function(){
            return"ready"
        }
        },
        ready:{socket_closed:function(){
            return"disconnected"
        },
            timeout:function(){
            return"ready"
        ...
        audiostart:{error:function(a){
            return this.rec=!1,this.handleError(new d("Error during recording",{code:"RECORD",data:a})),"ready"
        },
            socket_closed:function(){
        ...
        audioend:{socket_closed:function(){
            return this.timer&&clearTimeout(this.timer),"disconnected"
        },
            timeout:function(){
                return this.handleError(new d("Wit timed out",{code:"TIMEOUT"})),"ready"
            },
            error:function(a){
                return this.timer&&clearTimeout(this.timer),this.handleError(new d("Wit did not recognize intent",{code:"RESULT",data:a})),"ready"
            },
            result:function(a){
        ...
        a.prototype.fsm=function(a){
            var b,c,d,g;
            if(c=null!=(g=f[this.state])?g[a]:void 0,b=Array.prototype.slice.call(arguments,1),_.isFunction(c))
                switch(d=c.apply(this,b), e("fsm: "+this.state+" + "+a+" -> "+d,b), this.state=d,("audiostart"===d||"audioend"===d||"ready"===d||"connecting"===d||"disconnected"===d)&&_.isFunction(c=this["on"+d])&&c.call(window),d){
                    case"disconnected":
